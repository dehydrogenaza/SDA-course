...
//        settery i konstruktor.Stwórz interfejs Movable posiadający metodę move(MoveDirection moveDirection).
//        Zaimplementuj interfejs w klasach z poprzedniego zadania(Point2D oraz Circle).
//        Przy wywołaniu metody move(MoveDirection moveDirection),obiekty mają zmienić swoje położenie na podstawie
//        przekazanego kierunku(MoveDirection).
